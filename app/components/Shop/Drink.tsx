          ...
          {newArrivals.map((p, index) => (
            ...
            >
              <div className="w-full aspect-square bg-gray-50 rounded-xl mb-3 relative overflow-hidden flex items-center justify-center">
                <span className="absolute top-2 left-2 z-20 text-[7px] md:text-[8px] font-bold text-shadow-[2px_1px_2px_black] text-[#ffffff] px-1.5 py-0.5 rounded-md bg-[#53f141]">NEW</span>
