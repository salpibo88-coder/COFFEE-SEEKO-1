...
const drinks = [
  { name: "Seeko Coffee 1", category: "COFFEE SEEKO", date: "May 25, 2024", price: "5,000៛ ($1.25)", img: "1.jpg" },
  { name: "Seeko Coffee 2", category: "COFFEE SEEKO", date: "May 25, 2024", price: "5,000៛ ($1.25)", img: "5.jpg" },
  { name: "Seeko Coffee 3", category: "COFFEE SEEKO", date: "May 25, 2024", price: "5,000៛ ($1.25)", img: "6.jpg" },
  { name: "Seeko Coffee 4", category: "COFFEE SEEKO", date: "May 25, 2024", price: "5,000៛ ($1.25)", img: "7.jpg" },
  { name: "Seeko Coffee 5", category: "COFFEE SEEKO", date: "May 25, 2024", price: "5,000៛ ($1.25)", img: "8.jpg" },
  { name: "Seeko Coffee 6", category: "COFFEE SEEKO", date: "May 25, 2024", price: "5,000៛ ($1.25)", img: "9.jpg" },
  { name: "Seeko Coffee 7", category: "COFFEE SEEKO", date: "May 25, 2024", price: "5,000៛ ($1.25)", img: "10.jpg" },
  { name: "Seeko Coffee 8", category: "COFFEE SEEKO", date: "May 25, 2024", price: "5,000៛ ($1.25)", img: "11.jpg" },
];
    ...
    <>
      <section className="py-4 xl:py-6 w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">New Arrivals</h2>
