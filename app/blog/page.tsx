...
export default function CoffeeWebsite() {
  const posts = [
  ...
  return (
    <div className="font-sans overflow-x-hidden">
      ...
      {/* 1. HERO SECTION - Updated to match layout in image_f8c840.jpg */}
      <section 
        className="min-h-[600px] w-full flex flex-col lg:flex-row items-center justify-center p-6 md:p-12 gap-12"
        style={{
      ...
      >
        {/* Left: Images */}
        <div className="flex-1 flex justify-center items-center gap-4 animate-[float_4s_ease-in-out_infinite]">
          <img 
            ...
            alt="Coffee" 
            className="w-[45%] max-w-[400px] object-contain drop-shadow-2xl" 
          />
          <img 
            src="https://png.pngtree.com/png-vector/20250825/ourmid/pngtree-friendly-barista-serving-coffee-and-bag-of-beans-cartoon-on-transparent-png-image_17121905.webp" 
            alt="Splash" 
            className="w-[45%] max-w-[400px] object-contain drop-shadow-2xl" 
          />
        </div>
        ...
        {/* Right: Text */}
        <div className="flex-1 text-white space-y-4 animate-[slideInUp_1s_ease-out]">
          <h1 className="text-6xl md:text-8xl font-black leading-[0.9] animate-[fadeIn_1.5s_ease-in]">
            Everything<br/>
            only <span className="line-through decoration-4 text-[#39d62b] text-shadow-[2px_2px_1px_black] ">$1.25</span><br/>
            Coffee +<br/>
            Fresh Brew
          </h1>
          <p className="text-xl opacity-90 animate-[fadeIn_2s_ease-in]">
            Experience the finest roasted coffee, delivered fresh to your door or available in-store.
          </p>
        </div>
      </section>

      {/* 2. BLOG SECTION (Remains same) */}
      <section className="bg-[#f5f2ed] py-20 px-6 md:px-24">
